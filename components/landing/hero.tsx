  ...
  return (
    <section className="relative overflow-hidden container mx-auto">
      ...
      >
        ...
        >
          Grow on X like you never log off.
        </motion.h1>
        ...
        >
          Xenith keeps you showing up where growth actually happens — fresh
          posts and sharp replies in your voice, built around what&apos;s
          trending in your niche, every single day.
        </motion.p>
        ...
        >
          ...
          <Button variant="outline" size="lg" nativeButton={false} render={<Link href="#demo" />}>
            <IconPlayerPlayFilled data-icon="inline-start" aria-hidden />
            Watch the demo
          </Button>
        </motion.div>
